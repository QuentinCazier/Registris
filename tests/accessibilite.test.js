...
const PAGES = [
  ...
  '/admin/utilisateurs', '/admin/routage', '/admin/import', '/aide', '/admin/api', '/admin/configuration', '/admin/configuration?tester=1', '/absences', '/departs', '/approbations', '/admin/packs', '/admin/bibliotheque', '/indicateurs', '/rapprochements',
];
